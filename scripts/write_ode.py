#!/usr/bin/env python
"""Script to write the fixed ode_system.py with sustained dynamics."""
import os, textwrap

TARGET = os.path.join(os.path.dirname(os.path.dirname(__file__)), "models", "ode_system.py")
...
with open(TARGET, 'w', encoding='utf-8') as f:
    f.write(CODE)
print(f"Wrote {len(CODE)} chars to {TARGET}")
